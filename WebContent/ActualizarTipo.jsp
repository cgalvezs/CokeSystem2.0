	...
	<div class="wrapper row2">
		<div id="container" class="clear">
			...
			<div id="homepage" class="clear">
				...
				<html:form action="/ActualizarTipo" method="post"
					focus="nombre">
					<table>
						<tbody>
							<tr>
								<td>Tipo:</td>
								<td><html:select property="tipoActivoId">
										<html:option value="SELECCIONE..."></html:option>
										<html:options collection="assetsTipoList"
											property="tipoActivoId" labelProperty="tipoActivoTipo" />
									</html:select></td>
							</tr>
							<tr>
								<td>Nuevo Nombre:</td>
								<td style="border: 1px"><html:text property="tipoActivoTipo"
										size="15" /></td>
							</tr>
							<tr>
