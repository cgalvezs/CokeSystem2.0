    ...
    <div id="homepage" class="clear">
      ...
      <html:errors />
        <h2>Crear Usuario</h2>
        	...
        	<html:form action="/AgregarUsuario" method="post">
			<table>
			<tbody>
				<tr>
					<td>Area: </td>
					<td>
						<html:select property="userDescAreaId" >
							<html:option value="SELECCIONE..." ></html:option>
							<html:options collection="areaDescList" property="areaId" labelProperty="areaNombre"/>   
						</html:select> 
					</td>		
				</tr>
				<tr>
					<td>Centro Costo: </td>
						<td>
						<html:select property="userCentCostId" >
							<html:option value="SELECCIONE..."></html:option>
