    ...
    <div id="homepage" class="clear" align="center">
      <section id="services" class="clear">
        <form action="">
        	...
        	<h1 style="color: orange;">USUARIOS</h1>
        
			<a href="/Inventory/PopulateSelectAction.do" target="_self">
 				<img src="img/AddUser.png" width="200 200" "/>
			</a>
			
			<a href="/Inventory/PopulateSelectActionUsers.do" target="_self">
 				<img src="img/AddInvXUser.png" width="200 200" "/>
			</a>
			
			<a href="/Inventory/PopulateSelectActionActualizarUser.do" target="_self">
 				<img src="img/ActualizarUser.png" width="200 200" "/>
			</a>
			<a href="/Inventory/PopulateListarUsers.do" target="_self">
 				<img src="img/ListarUsuarios.png" width="200 200" "/>
			</a>
...
<div class="wrapper row3">
  <footer id="footer" class="clear">
    <p class="fl_left">Copyright &copy; 2014 - All Rights Reserved - <a href="#">WWW.ZevLaG.CL</a></p>
