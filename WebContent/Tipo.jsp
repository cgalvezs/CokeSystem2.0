    ...
    <div id="homepage" class="clear" align="center">
      <section id="services" class="clear">
        <form action="">
        	...
        	<h1 style="color: orange;">Tipo Objeto</h1>
        
			<a href="/Inventory/AgregarTipo.jsp" target="_self">
 				<img src="img/Add.png" width="200 200" "/>
			</a>
			
			<a href="/Inventory/SelectBorrarTipo.do" target="_self">
 				<img src="img/Delete.png" width="200 200" "/>
			</a>
			
			<a href="/Inventory/SelectActualizarTipo.do" target="_self">
 				<img src="img/Actualizar.png" width="200 200" "/>
			</a>
			
			<a href="/Inventory/PopulateListarTipos.do" target="_self">
