	...
	<div class="wrapper row2">
		<div id="container" class="clear">
			...
			<div id="homepage" class="clear">
				...
				<br>
				<h1>Agregar Inventario Por Usuario</h1>

				<html:form action="/InvXUsuario" method="post" focus="nombre">
					<table>
						<tbody>
							<tr>
							<td>Usuario:</td>
							<td><html:select property="userId">
									...
									<html:options collection="userIdNameList" property="userId" labelProperty="userNombre" />
								</html:select></td>
							</tr>
							
							<tr>
							<td>Tipo:</td>
							<td><html:select property="assetId">
									<html:option value="SELECCIONE..."></html:option>
									<html:options collection="idNameItAssetsList" property="itId" labelProperty="itDesc" />
								</html:select></td>
							</tr>
							
							<tr>
								<td>Condición al Entregar:</td>
								<td style="border: 1px"><html:text property="contOut"
								size="15" /></td>
							...
							<tr>
								<td>Otros:</td>
								<td style="border: 1px"><html:text property="actOtros"
								size="15" /></td>
