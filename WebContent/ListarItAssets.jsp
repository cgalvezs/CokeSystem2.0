...
<body>
	...
	<table border="1">
		...
		<tbody>
			cl.ciisa.cokedb.model.ItAssetsBean ItAssets = (cl.ciisa.cokedb.model.ItAssetsBean) pageContext.getAttribute("ItAssets");
				<tr>
					<td><bean:write property="itId" name="ItAssets" /></td>
					<td><bean:write property="itAssetsId" name="ItAssets" /></td>
					<td><bean:write property="itDesc" name="ItAssets" /></td>
					<td><bean:write property="itOtros" name="ItAssets" /></td>
				</tr>
			</logic:iterate>
		</tbody>
	</table>
