...
<body>
	...
	<table border="1">
		...
		<tbody>
			cl.ciisa.cokedb.model.InvAssetsBean InvAssets = (cl.ciisa.cokedb.model.InvAssetsBean) pageContext.getAttribute("InvAssets");
				<tr>
					<td><bean:write property="invId" name="InvAssets" /></td>
					<td><bean:write property="invAssetsId" name="InvAssets" /></td>
					<td><bean:write property="invDate" name="InvAssets" /></td>
					<td><bean:write property="invStock" name="InvAssets" /></td>
					<td><bean:write property="invOtros" name="InvAssets" /></td>
				</tr>
			</logic:iterate>
		</tbody>
	</table>
