    ...
    <div id="homepage" class="clear" align="center">
      <section id="services" class="clear">
        <form action="">
        	...
        	<h1 style="color: orange;">CENTROS DE COSTO</h1>
        
			<a href="/Inventory/AgregarCentCost.jsp" target="_self">
 				<img src="img/Add.png" width="200 200" "/>
			</a>
			
			<a href="/Inventory/PopulateSelectActionCentCost.do" target="_self">
 				<img src="img/Delete.png" width="200 200" "/>
			</a>
			
			<a href="/Inventory/PopulateSelectActualizarActionCentCost.do" target="_self">
 				<img src="img/Actualizar.png" width="200 200" "/>
			</a>
			
			<a href="/Inventory/PopulateListarCentCost.do" target="_self">
