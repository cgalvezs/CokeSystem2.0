...
<body>
	...
	<table border="1">
		...
		<tbody>
			cl.ciisa.cokedb.model.AssetsTipoBean AssetsTipo = (cl.ciisa.cokedb.model.AssetsTipoBean) pageContext.getAttribute("AssetsTipo");
				<tr>
					<td><bean:write property="tipoActivoId" name="AssetsTipo" /></td>
					<td><bean:write property="tipoActivoTipo" name="AssetsTipo" /></td>
				</tr>
			</logic:iterate>
		</tbody>
	</table>
