	...
	<div class="wrapper row2">
		<div id="container" class="clear">
			...
			<div id="homepage" class="clear">
				...
				<br>
				<br>
				<h1>Actualizar Centros de Costo</h1>

				<html:form action="/ActualizarCentroCosto" method="post"
					focus="nombre">
					<table>
						<tbody>
							<tr>
								<td>Centro Costo:</td>
								<td><html:select property="centId">
							...
							<tr>
								<td>Nuevo Nombre:</td>
								<td style="border: 1px"><html:text property="centNombre"
										size="15" /></td>
							</tr>
							<tr>
