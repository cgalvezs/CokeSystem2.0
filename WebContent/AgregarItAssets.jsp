	...
	<div class="wrapper row2">
		<div id="container" class="clear">
			...
			<div id="homepage" class="clear">
				...
				<br>
				<h1>Agregar It Asset</h1>

				<html:form action="/AgregarItAssets" method="post" focus="nombre">
					<table>
						<tbody>
							<tr>
							<td>Tipo:</td>
							<td><html:select property="itAssetsId">
									<html:option value="SELECCIONE..."></html:option>
									<html:options collection="assetsTipoList" property="tipoActivoId" labelProperty="tipoActivoTipo" />
								</html:select></td>
							</tr>
							
							<tr>
								<td>Modelo:</td>
								<td style="border: 1px"><html:text property="itDesc"
								size="15" /></td>
							...
							<tr>
								<td>Marca:</td>
								<td style="border: 1px"><html:text property="itOtros"
								size="15" /></td>
